...
import brandTexture from '@/assets/lanyard/brandTexture.png';
import './Lanyard.css';
...
function Band({ isMobile = false }: { isMobile?: boolean }) {
  ...
  const ropeTexture = useTexture(lanyardTexture);
  const cardTexture = useTexture(brandTexture);

  // Fix texture color + quality
  ...
  return (
    <>
      <group position={[0, 4, 0]}>
        ...
        >
          <CuboidCollider args={[1.44, 1.92, 0.01]} />
