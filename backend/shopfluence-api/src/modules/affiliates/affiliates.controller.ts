...
export class AffiliatesController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get my conversions (Affiliate)' })
  ...
  @Roles(UserRole.AFFILIATE)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get commission summary (Affiliate)' })
  ...
  @Roles(UserRole.AFFILIATE)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get click analytics (Affiliate)' })
  async getClicks(
    @CurrentUser('id') userId: string,
