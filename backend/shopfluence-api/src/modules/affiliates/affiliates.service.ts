...
export class AffiliatesService {
   ...
   */
  async getInfluencerConversions(
    influencerId: string,
    query: PaginationDto & { status?: ConversionStatus },
  ) {
  ...
  async getCommissionSummary(influencerId: string) {
    ...
    return {
      ...
      totalEarnings:
        Number(confirmed._sum.commissionAmount || 0) +
        Number(paidOut._sum.commissionAmount || 0),
    };
  }
