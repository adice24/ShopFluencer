...
export class UsersService {
  ...
  async updateProfile(userId: string, dto: UpdateProfileDto) {
    ...
    if (dto.displayName !== undefined)
      influencerUpdates.displayName = dto.displayName;
    if (dto.bio !== undefined) influencerUpdates.bio = dto.bio;
    if (dto.websiteUrl !== undefined)
      influencerUpdates.websiteUrl = dto.websiteUrl;
    if (dto.instagramHandle !== undefined)
      influencerUpdates.instagramHandle = dto.instagramHandle;
    if (dto.youtubeHandle !== undefined)
      influencerUpdates.youtubeHandle = dto.youtubeHandle;
    if (dto.tiktokHandle !== undefined)
      influencerUpdates.tiktokHandle = dto.tiktokHandle;
    if (dto.twitterHandle !== undefined)
      influencerUpdates.twitterHandle = dto.twitterHandle;
