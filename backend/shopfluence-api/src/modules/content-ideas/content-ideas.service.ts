    ...
    const ideasTemplate = [
      {
        ...
        hook: 'Ever wonder what actually goes into making...',
        cta: 'Drop your favorite tool in the comments!',
      },
      {
        title: 'Top 3 Mistakes Beginners Make',
        hook: 'If you want to succeed in this space, stop doing this right now.',
        cta: 'Save this so you dont forget!',
      },
      {
        title: 'A Day in the Life',
        hook: 'Come with me for a productive day doing what I love.',
        cta: 'What does your routine look like?',
      },
      {
        title: 'My Holy Grail Products',
        hook: 'I’ve tested hundreds of things, and these are the only ones I swear by.',
        cta: 'Check out the link in my bio for to get yours!',
      },
      {
        title: 'How I Generated X Results in 30 Days',
        hook: 'I couldn’t believe this strategy actually worked...',
        cta: 'Comment “STRATEGY” and I’ll DM you the exact step-by-step.',
      },
      {
        title: 'Debunking Common Myths',
        hook: 'Stop believing this massive lie about our industry.',
        cta: 'Tag a friend who needs to hear this.',
      },
      {
        title: 'The Ultimate Hacks Compilation',
        hook: 'These 5 secrets completely changed the game for me.',
        cta: 'Try number 3 and thank me later!',
      },
      {
        title: 'Unboxing / First Impressions',
        hook: 'I just got my hands on the most hyped release of the year.',
        cta: 'Would you buy this? Reply below!',
      },
      {
        title: 'Storytime: My biggest failure',
        hook: 'I almost quit entirely after this happened...',
        cta: 'Have you ever failed like this? Let’s chat.',
      },
      {
        title: 'Step-by-Step Mini Tutorial',
        hook: 'Here’s the fast-track way to achieve your goal by tonight.',
        cta: 'Share this with someone on a similar journey!',
      },
    ];
