import { Controller, Post, Body, Param, Get, Req, UseGuards, RawBodyRequest } from '@nestjs/common';
...
export class PaymentsController {
    ...
    async createIntent(@Body() body: CreatePaymentIntentDto) {
        return this.paymentsService.createPaymentIntent(body.orderId, body.idempotencyKey);
    }
