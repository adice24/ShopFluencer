...
export class CatalogController {
    ...
    async createCategory(@Body() body: { name: string; slug: string; description?: string; parentId?: string }) {
    ...
    async createBrand(@Body() body: { name: string; slug: string; description?: string; logoUrl?: string }) {
    ...
    async getProducts(@Query() query: PaginationDto & { categoryId?: string; brandId?: string }) {
